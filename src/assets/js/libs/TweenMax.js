        ...
        return (
          ...
          (k.render = function (a, b, c) {
            ...
            if ((o !== this._time && (a += this._time - o), a >= p - 1e-7 && a >= 0))
              ...
              m &&
                m._startTime < q &&
                ((this._time = a = m._startTime), (this._totalTime = a + this._cycle * (this._totalDuration + this._repeatDelay)))
            }
      ...
      function (a, b) {
        ...
        return (
          (g.cascadeTo = function (a, c, d) {
            ...
            for (
              a = i._targets || i.target, Za(a, k, m), i.render(c, !0, !0), Za(a, l), i.render(0, !0, !0), i._enabled(!0), e = m.length;
              --e > -1;
      ...
      E(),
        ...
        (h.isActive = function () {
          var a,
            ...
            c = this._startTime
          return (
            !b || (!this._gc && !this._paused && b.isActive() && (a = b.rawTime(!0)) >= c && a < c + this.totalDuration() / this._timeScale - 1e-7)
          )
        }),
