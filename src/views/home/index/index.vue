<template>
  <div class="index">
    <div class="header-wrapper">
      <mheader :headerStyle="headerStyle" @leftClick="onLeftClick" @centerClick="onCenterClick"
               @rightClick="onRightClick"></mheader>
    </div>
    <div class="scroll-list-wrap">
      <cube-scroll ref="scroll" :data="data" :options="options" :scrollEvents="['scroll']" @scroll="handleScroll">
        <cube-slide class="slide" ref="slide" :data="swipers" :interval="2000">
          ...
          <template #dots="props">
            <span class="dot" :class="{ active: props.current === index }" v-for="(item, index) in props.dots"
